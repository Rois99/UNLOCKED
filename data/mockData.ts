...
export const SKILLS: Skill[] = [
  // ── CALISTHENICS · PULL ─────────────────────────────────────────────────
  {
    ...
    category: 'pull', treeType: 'calisthenics', prerequisiteId: null,
  ...
  },
  {
    ...
    category: 'pull', treeType: 'calisthenics', prerequisiteId: '30_pullups',
  ...
  },
  {
    ...
    category: 'pull', treeType: 'calisthenics', prerequisiteId: '1_oap',
  ...
  // ── CALISTHENICS · PUSH ─────────────────────────────────────────────────
  {
    ...
    category: 'push', treeType: 'calisthenics', prerequisiteId: null,
    xp: 500, difficulty: 'intermediate',
  },
  {
    id: '1_hspu',
    ...
    category: 'push', treeType: 'calisthenics', prerequisiteId: '50_dips',
  ...
  },
  {
    ...
    category: 'push', treeType: 'calisthenics', prerequisiteId: '1_hspu',
  ...
  // ── CALISTHENICS · LEVER ────────────────────────────────────────────────
  {
    ...
    category: 'lever', treeType: 'calisthenics', prerequisiteId: null,
  ...
  },
  {
    ...
    category: 'lever', treeType: 'calisthenics', prerequisiteId: 'tuck_front_lever_10s',
  ...
  },
  {
    ...
    category: 'lever', treeType: 'calisthenics', prerequisiteId: 'adv_tuck_front_lever',
  ...
  // ── GYM · SQUAT ─────────────────────────────────────────────────────────
  {
    ...
    category: 'squat', treeType: 'gym', prerequisiteId: null,
  ...
  },
  {
    ...
    category: 'squat', treeType: 'gym', prerequisiteId: 'squat_100',
  ...
  },
  {
    ...
    category: 'squat', treeType: 'gym', prerequisiteId: 'squat_140',
    xp: 3000, difficulty: 'elite',
  },
  ...
  // ── GYM · BENCH ─────────────────────────────────────────────────────────
  {
    ...
    category: 'bench', treeType: 'gym', prerequisiteId: null,
    xp: 500, difficulty: 'intermediate',
  },
  {
    id: 'bench_120',
    ...
    category: 'bench', treeType: 'gym', prerequisiteId: 'bench_80',
    xp: 1200, difficulty: 'advanced',
  },
  {
    id: 'bench_160',
    ...
    category: 'bench', treeType: 'gym', prerequisiteId: 'bench_120',
  ...
  // ── GYM · DEADLIFT ──────────────────────────────────────────────────────
  {
    ...
    category: 'deadlift', treeType: 'gym', prerequisiteId: null,
  ...
  },
  {
    ...
    category: 'deadlift', treeType: 'gym', prerequisiteId: 'dead_140',
  ...
  },
  {
    ...
    category: 'deadlift', treeType: 'gym', prerequisiteId: 'dead_200',
 ...
 * Password "Admin3005" reserved for Supabase Auth wiring.
 */
export const MOCK_USER: User = {
  ...
  unlockedSkillIds: [
    ...
    // Gym (base lifts unlocked to seed both trees with interesting states)
